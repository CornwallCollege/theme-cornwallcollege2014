YUI.add('moodle-theme_cornwallcollege2014-awesomebar', function(Y) {
...
AwesomeBar.prototype = {
    ...
    initializer : function(config) {
        Y.all('.cornwallcollege2014-awesome-bar ul.dropdown li > span').each(this.enhanceAwesomeBar, this);
        Y.all('.cornwallcollege2014-awesome-bar ul.dropdown li.clickable-with-children > a').each(this.enhanceAwesomeBar, this);
    },
...
Y.extend(AwesomeBar, Y.Base, AwesomeBar.prototype, {
    NAME : 'cornwallcollege2014 theme AwesomeBar enhancer',
    ATTRS : {
...
M.theme_cornwallcollege2014.initAwesomeBar = function(cfg) {
