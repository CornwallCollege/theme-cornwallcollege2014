...
/**
 * Strings for component 'theme_cornwallcollege2014', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   theme_cornwallcollege2014
...
$string['configtitle'] = 'Cornwall College 2014 theme settings';
...
$string['awesomebarsettingsdesc'] = 'The "Awesomebar" is the black navigation bar that is fixed to the top of the browser window when using cornwallcollege2014.<br>The following settings relate to the "Awesomebar" and other page navigation.';
